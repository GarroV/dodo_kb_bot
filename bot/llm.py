...
SYSTEM_PROMPT = (
    ...
    "СТРАТЕГИЯ ПОИСКА:\n"
    "1. search_content ранжирует результаты по релевантности — доверяй порядку выдачи, в первую "
    "очередь используй верхние результаты, а не переформулируй запрос без необходимости.\n"
